...
__DEFINE__(1660283468072, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1660283468073,"./event-store":1660283468074}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660283468073, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1660283468074, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1660283468073,"./utils":1660283468075}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660283468075, function(require, module, exports) {
...
return __REQUIRE__(1660283468072);
})()
